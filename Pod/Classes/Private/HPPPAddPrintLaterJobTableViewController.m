...
- (void)viewDidLoad
{
    ...
    self.addToPrintQLabel.font = [hppp.appearance.addPrintLaterJobScreenAttributes objectForKey:HPPPAddPrintLaterJobScreenAddToPrintQFontAttribute];
    self.addToPrintQLabel.textColor = [hppp.appearance.addPrintLaterJobScreenAttributes objectForKey:HPPPAddPrintLaterJobScreenAddToPrintQColorAttribute];
    self.addToPrintQLabel.text = HPPPLocalizedString(@"Add to Print Queue", nil);

    self.nameTextView.font = [hppp.appearance.addPrintLaterJobScreenAttributes objectForKey:HPPPAddPrintLaterJobScreenJobNameFontAttribute];
    self.nameTextView.textColor = [hppp.appearance.addPrintLaterJobScreenAttributes objectForKey:HPPPAddPrintLaterJobScreenJobNameColorInactiveAttribute];
    
    self.dateTitleLabel.font = [hppp.appearance.addPrintLaterJobScreenAttributes objectForKey:HPPPAddPrintLaterJobScreenSubitemTitleFontAttribute];
    self.dateTitleLabel.textColor = [hppp.appearance.addPrintLaterJobScreenAttributes objectForKey:HPPPAddPrintLaterJobScreenSubitemTitleColorAttribute];
    self.dateTitleLabel.text = HPPPLocalizedString(@"Date", nil);

    self.dateLabel.font = [hppp.appearance.addPrintLaterJobScreenAttributes objectForKey:HPPPAddPrintLaterJobScreenSubitemFontAttribute];
    self.dateLabel.textColor = [hppp.appearance.addPrintLaterJobScreenAttributes objectForKey:HPPPAddPrintLaterJobScreenSubitemColorAttribute];
    
    self.printerNameTitleLabel.font = [hppp.appearance.addPrintLaterJobScreenAttributes objectForKey:HPPPAddPrintLaterJobScreenSubitemTitleFontAttribute];
    self.printerNameTitleLabel.textColor = [hppp.appearance.addPrintLaterJobScreenAttributes objectForKey:HPPPAddPrintLaterJobScreenSubitemTitleColorAttribute];
    self.printerNameTitleLabel.text = HPPPLocalizedString(@"Printer", nil);
    
    self.printerNameLabel.font = [hppp.appearance.addPrintLaterJobScreenAttributes objectForKey:HPPPAddPrintLaterJobScreenSubitemFontAttribute];
    self.printerNameLabel.textColor = [hppp.appearance.addPrintLaterJobScreenAttributes objectForKey:HPPPAddPrintLaterJobScreenSubitemColorAttribute];
    
    self.printerLocationTitleLabel.font = [hppp.appearance.addPrintLaterJobScreenAttributes objectForKey:HPPPAddPrintLaterJobScreenSubitemTitleFontAttribute];
    self.printerLocationTitleLabel.textColor = [hppp.appearance.addPrintLaterJobScreenAttributes objectForKey:HPPPAddPrintLaterJobScreenSubitemTitleColorAttribute];
    self.printerLocationTitleLabel.text = HPPPLocalizedString(@"Network", nil);
    
    self.printerLocationLabel.font = [hppp.appearance.addPrintLaterJobScreenAttributes objectForKey:HPPPAddPrintLaterJobScreenSubitemFontAttribute];
    self.printerLocationLabel.textColor = [hppp.appearance.addPrintLaterJobScreenAttributes objectForKey:HPPPAddPrintLaterJobScreenSubitemColorAttribute];
    ...
    UIButton *doneButton = [hppp.appearance.addPrintLaterJobScreenAttributes objectForKey:HPPPAddPrintLaterJobScreenDoneButtonAttribute];
...
- (void)setNavigationBarEditing:(BOOL)editing
{
    ...
    UIColor *nameTextFieldColor = [hppp.appearance.addPrintLaterJobScreenAttributes objectForKey:HPPPAddPrintLaterJobScreenJobNameColorInactiveAttribute];

    if (editing) {
        navigationBarTitle = nil;
        barTintColor = [UIColor HPPPHPTabBarSelectedColor];
        rightBarButtonItem = self.doneButtonItem;
        nameTextFieldColor = [hppp.appearance.addPrintLaterJobScreenAttributes objectForKey:HPPPAddPrintLaterJobScreenJobNameColorActiveAttribute];
    }
