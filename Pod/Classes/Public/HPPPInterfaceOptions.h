 ...
 */
@interface HPPPInterfaceOptions : NSObject
...
/*!
 * @abstract Specifies whether or not the double tap gesture is recognized. If double tap is enabled then the multiPageView:didDoubleTapPage: method will be called on the HPPPMultiPageViewDelegate. Note that single tap response will experience a slight delay when double tap is enabled and no delay when double tap is disabled.
 */
