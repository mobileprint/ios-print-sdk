...
- (void)testInit {
    ...
    pageRange = [[HPPPPageRange alloc] initWithString:@"" allPagesIndicator:allPages maxPageNum:10 sortAscending:FALSE];
    XCTAssert([pageRange.range isEqualToString:@""], @"InitWithString:@\"\" produced range: \"%@\"", pageRange.range);
              

    // Init with single page
    pageRange = [[HPPPPageRange alloc] initWithString:goodString2 allPagesIndicator:allPages maxPageNum:10 sortAscending:FALSE];
    ...
    pageRange = [[HPPPPageRange alloc] initWithString:allPages allPagesIndicator:allPages maxPageNum:10 sortAscending:FALSE];
    ...
    pageRange = [[HPPPPageRange alloc] initWithString:badString1 allPagesIndicator:allPages maxPageNum:10 sortAscending:FALSE];
    XCTAssert([pageRange.range isEqualToString:badStringResult1], @"InitWithString:%@ produced range: \"%@\"", badString1, pageRange.range);


    pageRange = [[HPPPPageRange alloc] initWithString:badString2 allPagesIndicator:allPages maxPageNum:10 sortAscending:FALSE];
    ...
    pageRange = [[HPPPPageRange alloc] initWithString:goodString1 allPagesIndicator:allPages maxPageNum:10 sortAscending:FALSE];
    XCTAssert([pageRange.range isEqualToString:goodStringResult1], @"InitWithString:%@ produced range: \"%@\"", goodString1, pageRange.range);


    // Verify sorting
    pageRange = [[HPPPPageRange alloc] initWithString:goodString1 allPagesIndicator:allPages maxPageNum:10 sortAscending:TRUE];
    ...
    pageRange = [[HPPPPageRange alloc] initWithString:outOfBounds allPagesIndicator:allPages maxPageNum:10 sortAscending:FALSE];
    ...
    pageRange = [[HPPPPageRange alloc] initWithString:outOfBounds2 allPagesIndicator:allPages maxPageNum:10 sortAscending:FALSE];
    ...
    pageRange = [[HPPPPageRange alloc] initWithString:extremeOutOfBounds allPagesIndicator:allPages maxPageNum:10 sortAscending:FALSE];
...
- (void)testGetPages {
    ...
    pageRange = [[HPPPPageRange alloc] initWithString:range allPagesIndicator:@"" maxPageNum:maxPage sortAscending:FALSE];
...
- (void)testAddPage {
    ...
    // Sorted test
    pageRange = [[HPPPPageRange alloc] initWithString:range allPagesIndicator:@"" maxPageNum:maxPage sortAscending:TRUE];
