...
@protocol HPPPSubstitutePaperTypeTableViewControllerDelegate;

/*!
 * @abstract Controls paper type table view selection
 */
@interface HPPPSubstitutePaperTypeTableViewController : UITableViewController

/*!
 * @abstract A delegate that is called when the user selects paper
 * @seealso HPPPPaperTypeTableViewControllerDelegate
 */
@property (nonatomic, weak) id<HPPPSubstitutePaperTypeTableViewControllerDelegate> delegate;
 ...
 */
@protocol HPPPSubstitutePaperTypeTableViewControllerDelegate <NSObject>
